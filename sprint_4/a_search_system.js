...
function solve() {
    ...
    for(let i = 0; i < countQueries; i++){
        ...
        const MAX_RESULTS = 5;
        const countPrint = Math.min(MAX_RESULTS, relevance.length);

        for(let k = 0; k < countPrint; k++ ){
